...
static char bss_data[50 * 1024 * 1024];   /* 50 MB BSS */

//static char data_section[10 * 1024 * 1024] = {
  //  [0 ... (10 * 1024 * 1024 - 1)] = 0xAA   10 MB initialized 
//};
...
int main() {
        ...
        printf("Touching BSS pages to create PTEs for test1...\n");
