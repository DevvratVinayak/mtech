...
- **logs/*log_<i>.txt** - Raw response time logs
- **trace/final.json** - Aggregated exec characterization data
- **trace/*log_<i>.txt** - Raw trace data for time analysis
...
- **Course:** CS614 - Operating Systems
- **Submission Date:** April 26, 2026
- **Contact:** harshkumar24@cse.iitk.ac.in
